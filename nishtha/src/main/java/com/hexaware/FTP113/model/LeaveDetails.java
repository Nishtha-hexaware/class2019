...
/**
  ...
  /**
   * list pending leave details.
   * @param argLeaId to get approvedeny lev details.
   * @return all pending details.
   */
  public static LeaveDetails listById(final int argLeaId) {
    LeaveDetails es = dao().find(argLeaId);
    return es;
  }
  /**
  ...
  public static String approveDeny(final int argLeaId,
    ...
    String res = "";
    LeaveDetails ld = LeaveDetails.listById(argLeaId);
    if (ld != null) {
